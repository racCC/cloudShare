          ...
          <div className="text-center">
            ...
            <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div className="space-y-4 sm:space-y-0 sm:inline-grid sm:grid-cols-2 sm:gap-5">
                <button className="flex items-center justify-center px-6 py-3 border border-transparent text-base font-semibold rounded-lg text-white bg-purple-600 hover:bg-purple-700 md:px-10 transition-all duration-200 shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                  Get Started
                </button>
                <button className="flex items-center justify-center px-6 py-3 border border-purple-600 text-base font-semibold rounded-lg text-purple-600 bg-white hover:bg-purple-50 md:px-10 transition-all duration-200 shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                  Sign In
                </button>
              </div>
            </div>
